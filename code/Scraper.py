...
"""
Web scraper for extracting aircraft listing data from ASO

- Uses Playwright to automate browser interactions
- Iterates through multiple pages of listings
- Extracts data fields and exports to a CSV file 
"""

def scrape_listings(page, base_url):
    """
    Scrapes aircraft listing data from ASO.com using playwright and returns a list of dictionaries representing aircraft listings.
    """
    ...
    def scrape_listings_on_page(page):
        # Launch browser and navigate to listing page
    ...
    def go_through_all_pages(page):
        ...
        while True:
            ...
            links = scrape_listings_on_page(page)
...
def main():
    ...
    base_url = "https://www.aso.com/listings/AircraftListings.aspx?searchId=61689612"
